...
<div align="left">
  <a href="Soma_Hargitai_CV.pdf" download>
    <img src="https://img.shields.io/badge/-Download CV as PDF-FF0000?style=flat-square&logo=adobe-acrobat-reader&logoColor=white"/>
  </a>
  <a href="mailto:hargitai.soma@gmail.com">
...
Senior Software Engineer and Tech Lead with 10+ years of experience building scalable full-stack systems and AI-driven applications. Specialized in TypeScript, React, Node.js, and LLM-powered architectures. Combines deep knowledge of cloud infrastructure, software design patterns, and AI integration to deliver production-ready products. Passionate about bridging engineering and creativity, leading teams, and turning concepts into intelligent, user-centric software.

## Core Competencies and Skills

* AI / ML: OpenAI API · LangChain · FastAPI · Python · RAG Pipelines · Vector DBs (ChromaDB, pgvector
* Frontend: React 18 · Next.js 15 · TypeScript · Tailwind CSS · shadcn/ui · Mantine · Material UI
* Backend: Node.js · NestJS · Express · MongoDB · PostgreSQL · GraphQL · NextAuth
* Cloud & DevOps: AWS · Azure · GCP · Vercel · Cloudflare · Docker · GitHub Actions · CI/CD
* Architecture & Leadership: System Design · API Design · Mentoring · Agile / Scrum · Technical Strategy

## AI Engineering Highlights

* Designed and deployed LLM-powered content generation and knowledge-retrieval systems using OpenAI, LangChain, and vector databases.
* Built RAG-based prototypes (e.g., nvolt) to demonstrate applied AI in information extraction and search.
* Integrated AI workflows into production web apps, improving marketing automation and analytics (WineConX).
* Researching LLM agents, prompt optimization, and practical AI architecture for SaaS scalability.

## Work Experience

### 🎨 Comic Sense | Founder & CTO

*2025 – Present*

Founded Comic Sense, a new-generation design and technology studio where creativity meets software engineering. The studio specializes in AR/VR experiences, custom web development, interactive design, and animation, helping brands and creators turn bold ideas into functional digital products.
As Founder and CTO, I lead the technical strategy and product development, integrating cutting-edge full-stack engineering, AI-driven tools, and modern design systems into every project. My background in software architecture, graphics, and typography allows me to bridge design and technology, ensuring that our solutions are visually striking, scalable, and technically reliable.

### 💻 Freelancer | Fullstack Developer and AI Strategist

*2020 – Present*

As a freelancer, I offer fullstack development and AI strategy services to businesses and creators. I help them build scalable web applications, integrate AI tools, and develop custom solutions tailored to their needs. My expertise in software architecture, design, and AI development allows me to deliver solutions that are both visually appealing and technically sound.

Some of my Projects:

* Prizma Foundation is a non-profit organization shaping forward-thinking EU initiatives in the fields of Human Rights, Sustainability, and Free Access to Public Information. As an advisor, I help them harness the power of AI to reimagine their projects, uncover new possibilities, and expand the organization’s horizons.

* Typoflow is leading biennial conference for typography and design professionals in Hungary. As a partner and supporter I built the website of the conference to manage their content and publish the conference program.

* Stella Stúdió creates educational magazines for children, helping them to learn English language. To the founder's request I built a website for the company, where they can manage their content and publish the magazines.

### 🌱 Career Break | 2025

I used the first half of 2025 to take a break from my career, to focus on my personal projects and to learn new things. My main learning focuses were: AI and Machine Learning, Cloud Computing and German Language. I also worked on several projects, like  

Some of my projects:

* For my family I created the Uncle Oscar app which is closed access app for family members to share photos, videos, documents, etc. They can add comments, stories, tags, accumulating family history. My final goal is to make it an open source project, allowing self-hosting or serving it as a SaaS for potential users.
  * Frontend: Next.js 15, React 18, TypeScript, Mantine, Radix UI, Tailwind CSS, i18n
  * Backend and Database: Next.js API Routes, NextAuth, MongoDB, Mongoose
  * Cloud and monitoring: AWS, Sentry
* [nvolt](https://nvolt.raptofu.com/) is an early RAG-based knowledge extraction tool I co-developed with Samu Balogh to explore and showcase the emerging potential of Retrieval-Augmented Generation. I designed and implemented its full technical foundation, demonstrating strong applied AI engineering skills and the ability to rapidly prototype innovative solutions using cutting-edge technologies.
  * Frontend: Next.js, TypeScript, Tailwind CSS, shadcn/ui
  * Backend: FastAPI, LangChain, OpenAI API, ChromaDB, PyPDF
...
### Metropolia University - Project Mentor
